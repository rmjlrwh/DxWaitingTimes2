...
for (test in all_tests) {
  ...
  # To change to on next rerun:
  # sd_prev_lb <- model_re_cis["sd_(Intercept)|NHSCode_PostMerge", "2.5 %"]
  # sd_prev_ub <- model_re_cis["sd_(Intercept)|NHSCode_PostMerge", "97.5 %"]
  # sd_latest_lb <- model_reversed_re_cis["sd_(Intercept)|NHSCode_PostMerge", "2.5 %"]
  # sd_latest_ub <- model_reversed_re_cis["sd_(Intercept)|NHSCode_PostMerge", "97.5 %"]
